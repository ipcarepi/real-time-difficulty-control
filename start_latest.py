...
class Application(QtWidgets.QMainWindow):
    ...
    def update_feature(self, feature, sensor = None):
        ...
        if not sensor == None:
            ...
            if features['peak_saccadic_velocity'] != self.peak_saccadic and not np.isnan(features['peak_saccadic_velocity']):
                ti = time.time()
